...
import { concatMultilineString, splitMultilineString } from './platform/common/utils/utils';
// import { CellExecutionCreator } from './kernelExecutionHelpers';
// import { IKernelController, KernelConnectionMetadata } from '../types';
// import type { KernelMessage } from '@jupyterlab/services';
// import { PYTHON_LANGUAGE } from './platform/common/utils/typesAndConsts';
// // // import { traceInfoIfCI, traceError, traceWarning } from '../../platform/logging';
// import { sendTelemetryEvent, Telemetry } from '../../telemetry';
// import { createOutputWithErrorMessageForDisplay } from '../../platform/errors/errorUtils';  // Defined here
...
import { NotebookCellExecutionWrapper } from "./cellExecutionMessageHandler";
...
export function translateCellDisplayOutput(output: NotebookCellOutput): JupyterOutput {
    ...
    switch (outputType) {
        ...
        default: {
            ...
            // sendTelemetryEvent(Telemetry.VSCNotebookCellTranslationFailed, undefined, { outputType });
...
//         let displayName = kernelSpec.display_name || kernelConnection.interpreter.displayName || '';
