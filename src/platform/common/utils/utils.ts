...
// import * as uriPath from '../../platform/vscode-path/resources';  // CHANGE: This is used in getResourceType below
...
// // import { traceError, traceInfo } from '../logging';  // CHANGE: disabled logging, too complicated

import { ICell } from './typesAndConsts';
